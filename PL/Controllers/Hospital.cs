        ...
        public IActionResult Form(int? IdHospital)
        {
            ...
            if (IdHospital != null)
            {
                ...
                if (resultadoHospital)
                {
                    ...
                    Dictionary<string, object> objetoEspecialidad = BL.Especialidades.GetAll();
                    ML.Especialidad especialidad = (ML.Especialidad)objetoEspecialidad["Especialidad"];
                    hospital.Especialidad.Especialidads = especialidad.Especialidads;
                    return View(hospital);
                }
                else
                {
            ...
            else
            {
                ...
                Dictionary<string, object> resultEspecialidad = BL.Especialidades.GetAll();
                ML.Especialidad especialidades = (ML.Especialidad)resultEspecialidad["Especialidad"];
                hospital.Especialidad.Especialidads = especialidades.Especialidads;
                return View(hospital);
            }
        }
        [HttpPost]
